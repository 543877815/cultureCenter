	 		 ...
	 		 */
	 		 $('#carousel_setting .submit').each(function(index, el) {
	 		 	$(this).on('click', function(event) {
	 		 		...
	 		 		stringNumber = newPath.indexOf('news'),
	 		 		newPathUpload = '/root/apache-tomcat-8.5.16/webapps/' + newPath.substring(stringNumber);
	 		 ...
	 		 */
	 		 $('#carousel_setting .delete').each(function(index, el) {
	 		 	$(this).on('click', function(event) {
	 		 		...
	 		 		stringNumber = newPath.indexOf('news'),
	 		 		pathDelete = '/root/apache-tomcat-8.5.16/webapps/' + newPath.substring(stringNumber);
